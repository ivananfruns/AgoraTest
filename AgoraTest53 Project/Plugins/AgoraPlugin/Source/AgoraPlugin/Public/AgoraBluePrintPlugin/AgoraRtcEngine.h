...
public:
	...
	//UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	//FString GenerateToken(FString appId, FString appCert, FString channelName, uint32_t uid, FString uidString, uint32_t expirationTimeInSeconds);
	...
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	void getAudioOutputDevices(TArray<FString>& IDs, TArray<FString>& Names, FString& currentID, FString& currentName);
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	void getAudioInputDevices(TArray<FString>& IDs, TArray<FString>& Names, FString& currentID, FString& currentName);
	
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	void GetWebcamDevices(TArray<FString>& IDs, TArray<FString>& Names, FString& currentID);

	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	void SetWebcamDevice(FString ID);
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	void setInputAudioDevice(FString ID);
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	void setOutputAudioDevice(FString ID);
